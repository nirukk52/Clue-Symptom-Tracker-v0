...
| **Secondary action** | I'll choose later *(still lands on symptoms-first setup)* |
...
| **Cards** | Awareness / Tracking / Insight / Action *(use your exact quote sets)* |
| **CTA** | Next |
...
*Shown if Awareness/Action mode OR high severity*
...
**Any likely drivers?** *(optional)*

| Element | Copy |
|---------|------|
| Helper | Pick any that fit. Skip if you're wiped. |
| Chips | *Varies by Feature:* missed meds, poor sleep, stress spike, food trigger, etc. |
